...
import com.zulham.mtv.core.utils.LiveDataUtilsTest
...
class ShowRepositoryTest {
    ...
    private val dummyMovie = DataMapper.generateDummyMovie()
    private val dummyTV = DataMapper.generateDummyTV()
    ...
    @Test
    fun getMovieList(){
        val dummyMovies = DataMapper.generateDummyMovie()
    ...
    @Test
    fun getTVList(){
        val dummyTVs = DataMapper.generateDummyTV()
